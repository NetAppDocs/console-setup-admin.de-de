...
summary: Administratoren können die NetApp Console so konfigurieren, dass ein Benutzer zur Eingabe seiner ONTAP Anmeldeinformationen aufgefordert wird. 
---
= ONTAP-Berechtigungen für ONTAP System Manager in der NetApp Console durchsetzen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
