...
[NOTE]
====
* Die Konsole versendet E-Mail-Benachrichtigungen für Agenten, Lizenzen und Abonnements, NetApp Copy and Sync, NetApp Backup and Recovery und NetApp Ransomware Resilience.
...
.Schritte
. Wählen Sie *Administration > Benachrichtigungseinstellungen*.
