...
Benutzer mit der Rolle *Organisationsadministrator* oder *Ordner- oder Projektadministrator* sind dafür verantwortlich, anderen Benutzern Rollen zuzuweisen. Sie können Zugriffsrollen auf Projekt- oder Ordnerbasis zuweisen. Zugriffsrollen nach Projekt oder Ordner zuweisen.  Weisen Sie beispielsweise einem Benutzer für ein Projekt die Administratorrolle „Ransomware Resilience“ und für ein anderes Projekt die Administratorrolle „SnapCenter“ zu.  Um einem Benutzer die Administratorrolle „Ransomware Resilience“ für alle Projekte in einem Ordner zuzuweisen, weisen Sie die Rolle auf Ordnerebene zu.
...
Weisen Sie Rollen entsprechend Ihrer IAM-Strategie zu, um die Sicherheit zu verbessern.  IAM-Rollen beschränken den Benutzerzugriff auf das Notwendigste.
...
Wenn Sie Ihrer Organisation ein Mitglied hinzufügen, werden Sie aufgefordert, ihm eine Rolle zuzuweisen. Sie können überprüfen, welche Rollen ihnen aktuell zugewiesen sind.
