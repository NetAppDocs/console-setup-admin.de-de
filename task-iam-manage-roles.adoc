...
Benutzer mit der Rolle *Organisationsadministrator* oder *Ordner- oder Projektadministrator* sind dafür verantwortlich, anderen Benutzern Rollen zuzuweisen. Sie können Zugriffsrollen auf Projekt- oder Ordnerbasis zuweisen. Sie können einem Benutzer beispielsweise für ein Projekt die Administratorrolle „Ransomware Resilience“ und für ein anderes Projekt die Administratorrolle „SnapCenter“ zuweisen. Alternativ können Sie einem Benutzer, der die Administratorrolle für Ransomware-Resilienz für alle Projekte innerhalb eines bestimmten Ordners benötigt, diese Rolle auf Ordnerebene zuweisen.
