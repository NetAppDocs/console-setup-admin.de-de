...
* Die in Option 1 aufgeführten Endpunkte werden ab der Version 3.9.47 des Console-Agenten unterstützt. Es besteht keine Abwärtskompatibilität mit früheren Versionen des Console-Agenten.
