...
---
= Stellen Sie einen Console-Agenten lokal mithilfe von VCenter bereit.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Als VMware-Nutzer können Sie eine OVA-Datei verwenden, um einen Konsolenagenten in Ihrem vCenter bereitzustellen. Der OVA-Download bzw. die URL ist über die NetApp Console verfügbar.
...
NetApp unterstützt die Installation des Console-Agenten in Ihrer vCenter-Umgebung. Die OVA-Datei enthält ein vorkonfiguriertes VM-Image, das Sie in Ihrer VMware-Umgebung bereitstellen können. Ein Dateidownload oder eine URL-Bereitstellung ist direkt von der NetApp Console verfügbar. Sie enthält die Console-Agent-Software und ein selbstsigniertes Zertifikat.
