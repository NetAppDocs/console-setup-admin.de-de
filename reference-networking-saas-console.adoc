...
| Wenn sich der Konsolenagent in einer AWS-Regierungsregion befindet: \https://*.blob.core.windows.net https://cloudmanagerinfraprod.azurecr.io | Um Images für Console-Agent-Upgrades zu erhalten, wenn der Console-Agent in einer AWS Government-Region installiert ist. 


| Wenn sich der Konsolenagent in einer Azure-Regierungsregion befindet: \https://*.blob.core.windows.net https://occmclientinfragov.azurecr.us | Um Images für Console-Agent-Upgrades zu erhalten, wenn der Console-Agent in einer Azure Government-Region installiert ist. 
...
| Um Images für Console-Agent-Upgrades zu erhalten, wenn der Console-Agent in einer kommerziellen Region oder souveränen Region installiert ist. [cols=3*,options="header,autowidth"] 
|===
