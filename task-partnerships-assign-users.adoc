...
---
= Partnermitglieder in der NetApp Console verwalten
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Sie können Benutzer jederzeit aus einer Partnerschaft entfernen. Durch das Entfernen eines Benutzers aus einer Partnerschaft wird dessen Zugriff auf alle Ressourcen der Partnerorganisation sofort widerrufen.
...
Wenn Sie Mitglieder zu einer Partnerschaft hinzufügen, muss der *Partnership admin* der Partnerorganisation ihnen Rollen für bestimmte Ressourcen in ihrer Organisation zuweisen, bevor sie auf diese Ressourcen zugreifen können.
...
. Wählen Sie das Aktionsmenü image:icon-action.png["ein Symbol mit drei vertikalen Punkten"] neben der bestehenden Partnerschaft, zu der Sie Mitglieder hinzufügen möchten, und wählen Sie *Mitglieder hinzufügen*.
. Wählen Sie ein oder mehrere Mitglieder aus, die Sie der Partnerschaft hinzufügen möchten, und wählen Sie *Hinzufügen* aus.
...
Sie können Mitglieder jederzeit aus einer Partnerschaft entfernen. Durch das Entfernen eines Benutzers aus einer Partnerschaft wird dessen Zugriff auf alle Ressourcen der Partnerorganisation sofort widerrufen.
...
. Wählen Sie *Partnerschaften* aus.
. Wählen Sie die Registerkarte *Partnerschaft erhalten*.
. Wählen Sie das Aktionsmenü image:icon-action.png["ein Symbol mit drei vertikalen Punkten"] neben dem Mitglied, das Sie entfernen möchten, und wählen Sie *Zuordnung entfernen*.
