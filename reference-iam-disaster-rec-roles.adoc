...
* *Administrator für Notfallwiederherstellung*: Führen Sie beliebige Aktionen durch.
* *Disaster Recovery Failover-Administration*: Failover und Migrationen durchführen.
* *Administrator für Notfallwiederherstellungsanwendungen*: Replikationspläne erstellen. Replikationspläne ändern. Starten Sie Test-Failover.
...
|===
| Funktion und Aktion | Disaster Recovery-Administrator | Disaster Recovery-Failover-Administrator | Disaster Recovery-Anwendungsadministrator | Disaster Recovery-Viewer 
