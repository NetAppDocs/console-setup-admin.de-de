...
summary: Die NetApp Console ermöglicht die zentrale Verwaltung von NetApp -Speicher- und Datendiensten in lokalen und Cloud-Umgebungen im Unternehmensmaßstab. 
---
...
NetApp bietet zwei Bereitstellungsmodi für die NetApp Console: Der _Standardmodus_ verwendet eine Software-as-a-Service-Schicht (SaaS) für die volle Funktionalität, während der _eingeschränkte Modus_ die ausgehende Konnektivität begrenzt.
