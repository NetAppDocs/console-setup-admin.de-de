...
* *Backup und Recovery Backup-Administrator*: Führt Backups in lokalen Snapshots durch, repliziert auf sekundären Speicher und sichert auf Objektspeicher in NetApp Backup und Recovery.
* *Backup und Recovery Wiederherstellungsadministrator*: Workloads mithilfe von NetApp Backup und Recovery wiederherstellen.
* *Backup und Recovery-Klonadministrator*: Anwendungen und Daten mithilfe von NetApp Backup und Recovery klonen.
