...
Die Konsole unterstützt keine Firewall-Konfigurationen mit aktivierter SSL-Entschlüsselung. Wenn die SSL-Entschlüsselung aktiviert ist, werden Fehlermeldungen in der Konsole angezeigt und die Agenteninstanz wird als *Getrennt* angezeigt.
