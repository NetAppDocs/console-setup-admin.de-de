...
summary: Die Firewall-Regeln von Google Cloud für den Agenten erfordern sowohl eingehende als auch ausgehende Regeln. Die NetApp Console erstellt diese Sicherheitsgruppe automatisch, wenn Sie einen Console-Agenten über die Console erstellen. Für andere Installationsoptionen müssen Sie diese Sicherheitsgruppe manuell einrichten. 
---
= NetApp Console-Agent Firewall-Regeln in Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Die Firewall-Regeln von Google Cloud für den Agenten erfordern sowohl eingehende als auch ausgehende Regeln. Die NetApp Console erstellt diese Sicherheitsgruppe automatisch, wenn Sie einen Console-Agenten über die Console erstellen. Für andere Installationsoptionen müssen Sie diese Sicherheitsgruppe manuell einrichten.
...
| DNS | UDP | 53 | DNS | Wird von der Datenklassifizierung für die DNS-Auflösung verwendet 
|===