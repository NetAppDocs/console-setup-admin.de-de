...
summary: Um mit der Identitäts- und Zugriffsverwaltung in der NetApp Console zu beginnen, passen Sie die Hierarchie der Organisation an, fügen Sie zusätzliche Mitglieder hinzu, fügen Sie Ressourcen hinzu oder ermitteln Sie sie und verknüpfen Sie diese Ressourcen mit Projekten. 
---
...
Sie benötigen *Org admin* oder *Super admin* Berechtigungen, um Identitäten und Zugriffsrechte für Ihre Organisation zu verwalten. Mit *Folder or project admin* Berechtigungen können Sie nur die Ordner und Projekte verwalten, auf die Sie Zugriff haben.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Fünf"]Bestätigen Sie Ihre Organisation (optional)
[role="quick-margin-para"]
Wenn Ihr Team die Organisationsverifizierung nutzt, verknüpfen Sie Ihre Console-Organisation mit der Identität Ihres NetApp Geschäftskontos.

[role="quick-margin-para"]
link:task-verify-organization.html["Erfahren Sie, wie Sie Ihre Organisation verifizieren können"].
...
* link:concept-verified-organization.html["Erfahren Sie mehr über verifizierte Organisationen in der NetApp Console"]
