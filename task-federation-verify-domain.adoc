...
Wenn Sie beispielsweise Microsoft Entra ID verwenden, können Sie die Schritte in der Microsoft-Dokumentation link:https://learn.microsoft.com/en-us/entra/fundamentals/add-custom-domain["Fügen Sie eine Domäne mit Microsoft Entra ID hinzu"] befolgen.
