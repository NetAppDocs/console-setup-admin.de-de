...
+
** Wählen Sie die Version, die den privaten Modus unterstützt. Überprüfen Sie das link:whats-new.html["Versionshinweise"] für die neueste unterstützte Version.
** Laden Sie das Offline-Installationsprogramm für Netzwerke ohne Internetzugang herunter.
