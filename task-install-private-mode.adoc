...
---
= Den NetApp Console Agent im privaten Modus bereitstellen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
--
Übergeben Sie dem Console-Agenten die Anmeldeinformationen für den Azure-Dienstprinzipal, den Sie zuvor eingerichtet haben.
