...
image:diagram_permissions_initial_aws.png["Ein konzeptionelles Bild, das die Konsole zeigt, die den Konsolenagenten in einem AWS-Konto bereitstellt. Einer IAM-Rolle wird eine IAM-Richtlinie zugewiesen, die an die Konsole angehängt ist."]
