...
---
= Einen NetApp Console Agenten aus dem Azure Marketplace erstellen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Stellen Sie sicher, dass der Netzwerkstandort, an dem Sie den Console-Agenten installieren möchten, die folgenden Anforderungen erfüllt. Diese Anforderungen ermöglichen es dem Console-Agenten, Ressourcen in Ihrer Hybrid-Cloud zu verwalten.
...
.Ergebnis
Sie haben nun den Console-Agenten installiert und ihn mit Ihrer Console-Organisation verbunden.
