...
---
= Manuelle Bereitstellung eines Console-Agenten vor Ort
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Als VMware-Benutzer können Sie eine OVA verwenden, um einen Console-Agenten in Ihrem vCenter bereitzustellen. link:task-install-agent-on-prem-ova.html["Erfahren Sie mehr über die Bereitstellung eines Agenten in einem vCenter."]
