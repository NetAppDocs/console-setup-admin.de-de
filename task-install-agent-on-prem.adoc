...
+
Wählen Sie aus, ob Sie die Agenteninstallationsdateien herunterladen oder eine URL zu den Dateien kopieren möchten.
...
NOTE: Wenn Sie einen transparenten Proxy konfigurieren möchten, können Sie dies tun, nachdem Sie einen Agenten installiert haben. link:reference-agent-maint-console-proxy.html["Erfahren Sie mehr über die Agentenwartungskonsole."].
