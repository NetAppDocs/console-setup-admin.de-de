...
Wählen Sie einen oder mehrere Dienste zur Validierung aus. Gültige Dienstnamen sind: *`PLATFORM` wodurch die Netzwerkverbindung zu den erforderlichen Console-Endpunkten sowie die Öffnung der erforderlichen Ports für den Console-Agenten überprüft wird.
