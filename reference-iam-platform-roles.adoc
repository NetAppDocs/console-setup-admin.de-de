...
summary: Weisen Sie Benutzern Plattformrollen zu, um ihnen Berechtigungen zum Verwalten der NetApp Console, zum Zuweisen von Rollen, zum Hinzufügen von Benutzern, zum Erstellen von Konsolenagenten und zum Verwalten von Föderationen zu erteilen. 
---
...
| Systeme über die Console erstellen, ändern oder löschen (Systeme hinzufügen oder ermitteln) | Ja | Ja 
