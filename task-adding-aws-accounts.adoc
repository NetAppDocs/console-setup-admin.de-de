...
*** link:task-install-connector-aws-bluexp.html#aws-permissions-agent["Anzeigen der Agent-Bereitstellungsrichtlinie"]
...
.Bevor Sie beginnen
Sie müssen einen Konsolenagenten erstellen, bevor Sie ein Abonnement konfigurieren können. link:concept-connectors.html#connector-installation["Erfahren Sie, wie Sie einen Konsolenagenten erstellen"] .
