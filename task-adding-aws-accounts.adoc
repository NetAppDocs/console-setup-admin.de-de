...
Wenn Sie gerade erst mit der Konsole beginnen,link:concept-accounts-aws.html["Erfahren Sie, wie die NetApp Console AWS-Anmeldeinformationen und -Berechtigungen verwendet"] .
...
+
.. *Speicherort der Anmeldeinformationen*: Wählen Sie *Amazon Web Services > NetApp Console*.
