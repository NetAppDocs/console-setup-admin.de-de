...
summary: NetApp Console Identitäts- und Zugriffsverwaltung bietet Administratorrollen, die Sie den Mitgliedern Ihrer Organisation zuweisen können, die Zugriff auf Google Cloud NetApp Volumes benötigen. 
---
...
Google Cloud NetApp Volumes verwendet die folgenden Rollen:
