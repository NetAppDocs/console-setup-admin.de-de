...
| Sicherung und Wiederherstellung | 5.0.2 (9. Februar 2026) | Gehe zu https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["Was ist neu auf der Seite NetApp Backup and Recovery"^]. 
