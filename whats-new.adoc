...
summary: Erfahren Sie, was es Neues bei der NetApp Console-Administration gibt. 
---
= Neues in der NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Informieren Sie sich über die Neuerungen bei den Verwaltungsfunktionen der NetApp Console : Identitäts- und Zugriffsverwaltung (IAM), Konsolenagenten, Anmeldeinformationen von Cloud-Anbietern und mehr.
...
| NetApp Backup and Recovery | 5.0.3 (2. März 2026) | Gehe zu https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["Was ist neu auf der Seite NetApp Backup and Recovery"^]. 


| NetApp Data Classification | 1.5.1 (9. Februar 2026) | Gehe zu https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html["Was ist neu auf der Seite NetApp Klassifizierung"^]. 
|===
...
==== Neue Zugriffsrollen für BlueXP backup and recovery, BlueXP disaster recovery und Föderationsverwaltung
...
| Sicherung und Wiederherstellung | 12. Mai 2025 | Gehen Sie zum https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["Was ist neu auf der BlueXP backup and recovery?"^] und beziehen Sie sich auf die Änderungen, die in der Version vom Mai 2025 enthalten sind. 


| Einstufung | 12. Mai 2025 (Version 1.43) | Gehen Sie zum https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html["Was ist neu auf der BlueXP classification ?"^] und beziehen Sie sich auf die in den Versionen 1.38 bis 1.371.41 enthaltenen Änderungen. 
|===
Weitere Einzelheiten zum privaten Modus, einschließlich der Aktualisierungsinformationen, finden Sie hier:
...
| Sicherung und Wiederherstellung | 22. November 2024 | Gehen Sie zum https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["Was ist neu auf der BlueXP backup and recovery?"^] und beziehen Sie sich auf die Änderungen, die in der Version vom November 2024 enthalten sind 


| Einstufung | 4. November 2024 (Version 1.37) | Gehen Sie zum https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html["Was ist neu auf der BlueXP classification ?"^] und beziehen Sie sich auf die Änderungen in den Versionen 1.32 bis 1.37 


| Cloud Volumes ONTAP Verwaltung | 11. November 2024 | Gehen Sie zum https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html["Neuigkeiten zur Cloud Volumes ONTAP -Verwaltungsseite"^] und beziehen Sie sich auf die Änderungen, die in den Versionen vom Oktober 2024 und November 2024 enthalten sind 


| On-Premises ONTAP Clusterverwaltung | 26. November 2024 | Gehen Sie zum https://docs.netapp.com/us-en/storage-management-ontap-onprem/whats-new.html["Neuigkeiten zur On-Premises ONTAP -Clusterverwaltungsseite"^] und beziehen Sie sich auf die Änderungen, die in der Version vom November 2024 enthalten sind 
|===
...
Wenn Sie BlueXP im eingeschränkten Modus oder im privaten Modus verwenden, ist die Benutzeroberfläche über die Connector-VM zugänglich, die in Ihrer Cloud-Region oder lokal bereitgestellt ist. Standardmäßig verwendet BlueXP ein selbstsigniertes SSL-Zertifikat, um einen sicheren HTTPS-Zugriff vom lokalen Webbrowser bereitzustellen.
...
Die AWS- und Azure-Richtlinien für den Connector wurden aktualisiert, um Berechtigungen zu entfernen, die nicht mehr erforderlich sind. Die Berechtigungen bezogen sich auf BlueXP edge caching sowie auf die Erkennung und Verwaltung von Kubernetes-Clustern in Azure und AWS.
...
----
Diese Berechtigungen sind für die Unterstützung von Virtual Machine Scale Sets durch Cloud Volumes ONTAP erforderlich. Wenn bereits Connectors vorhanden sind und diese neue Funktion genutzt werden soll, müssen diese Berechtigungen zu den benutzerdefinierten Richtlinien hinzugefügt werden, die mit den Azure-Anmeldeinformationen verknüpft sind.
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html["Erfahren Sie, wie Sie mit BlueXP im privaten Modus beginnen"]
* https://docs.netapp.com/us-en/bluexp-setup-admin/task-upgrade-connector.html["Erfahren Sie, wie Sie den Connector im privaten Modus aktualisieren."]
* https://docs.netapp.com/us-en/data-services-backup-recovery/whats-new.html["Erfahren Sie, was es Neues bei BlueXP backup and recovery gibt"^]
* https://docs.netapp.com/us-en/data-services-data-classification/whats-new.html["Erfahren Sie, was es Neues bei der BlueXP classification gibt"^]
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html["Erfahren Sie, was es Neues beim Cloud Volumes ONTAP Management in BlueXP gibt"^]
...
Wenn Sie bereits einen Agenten unter RHEL 7 oder CentOS 7 betreiben, unterstützt NetApp kein Upgrade oder keine Konvertierung des Betriebssystems auf RHEL 8 oder 9. Es ist erforderlich, einen neuen Agenten auf einem unterstützten Betriebssystem zu erstellen. Die folgenden Schritte beschreiben den Wechsel auf hoher Ebene:
...
** https://docs.netapp.com/us-en/storage-management-fsx-ontap/use/task-create-fsx-system.html["Erstellen oder entdecken Sie ein FSx für ONTAP -System"^]
