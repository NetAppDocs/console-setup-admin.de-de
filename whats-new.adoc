...
summary: 'Informieren Sie sich über die Neuerungen bei den Verwaltungsfunktionen der NetApp Console : IAM, Konsolenagenten, Anmeldeinformationen für Cloud-Anbieter und mehr.' 
---
= Was ist neu
:hardbreaks:
:allow-uri-read: 
