...
| link:reference-iam-platform-roles.html#super-admin-roles["Super Viewer"] | Weist dem Benutzer eine Teilmenge der Betrachterrollen zu. Diese Rolle ist für kleinere Organisationen konzipiert, die die Konsolenverantwortung möglicherweise nicht auf mehrere Benutzer verteilen müssen. 
|===
...
| link:reference-iam-gcnv-roles.html["Google Cloud NetApp Volumes Viewer"] | Benutzer mit der Benutzerrolle „Google Cloud NetApp Volumes“ können Google Cloud NetApp Volumes anzeigen. 
...
| link:reference-iam-backup-rec-roles.html["Backup- und Wiederherstellungsklon-Administrator"] | Anwendungen und Daten in Backup und Recovery klonen. 
