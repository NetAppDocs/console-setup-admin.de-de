...
---
= Den NetApp Console Agent manuell in Azure installieren
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Bevor Sie beginnen
* link:concept-agent-install-options.html#agent-cloud-manual-deploy["Erfahren Sie, wann Sie in Azure manuell bereitstellen sollten"].
