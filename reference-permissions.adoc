...
[role="lead"]
Um die Funktionen und Dienste der NetApp Console nutzen zu können, müssen Sie Berechtigungen erteilen, damit der Konsolenagent Vorgänge in Ihrer Cloud-Umgebung ausführen kann. Verwenden Sie die Links auf dieser Seite, um schnell auf die Berechtigungen zuzugreifen, die Sie je nach Ihrem Ziel benötigen.
