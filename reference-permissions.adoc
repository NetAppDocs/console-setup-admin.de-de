...
| Bereitstellen eines Konsolenagenten über die Konsole | Der Benutzer, der einen Konsolenagenten aus der Konsole erstellt, benötigt bestimmte Berechtigungen, um die Instanz in AWS bereitzustellen. | link:task-install-connector-aws-bluexp.html#aws-permissions-agent["AWS-Berechtigungen einrichten"] 
