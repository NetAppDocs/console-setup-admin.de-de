...
| Einen Konsolenagenten über die Konsole bereitstellen Um einen Konsolenagenten in AWS bereitzustellen, benötigt der Benutzer bestimmte Berechtigungen. | link:task-install-agent-aws-console.html#aws-permissions-agent["AWS-Berechtigungen einrichten"] | Berechtigungen für einen Konsolenagenten bereitstellen 
|===
...
Halten Sie die Richtlinie auf dem neuesten Stand, da in späteren Versionen neue Berechtigungen hinzugefügt werden.
 a| 
