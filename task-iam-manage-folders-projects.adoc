...
Die Konsole erstellt automatisch ein Projekt für Sie, wenn Sie eine neue Organisation anlegen. Die meisten Organisationen benötigen mehr als ein Projekt sowie Ordner, um die Dinge übersichtlich zu organisieren. link:concept-identity-and-access-management.html["Erfahren Sie mehr über die Ressourcenhierarchie in der NetApp Console."]Die
