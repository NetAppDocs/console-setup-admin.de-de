...
image:diagram_permissions_multiple_azure.png["Eine konzeptionelle Abbildung, die das ursprüngliche Azure-Konto zeigt, das Berechtigungen über eine benutzerdefinierte Rolle und eine verwaltete Identität erhält, sowie zwei zusätzliche Konten, die Berechtigungen über eine benutzerdefinierte Rolle und einen Dienstprinzipal erhalten."]
