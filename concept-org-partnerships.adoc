...
---
= Partnerschaften in der NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Durch die Schaffung von Partnerschaften zwischen Organisationen ermöglicht die NetApp Console Partnern die sichere Verwaltung von NetApp Ressourcen über Organisationsgrenzen hinweg, wodurch die Zusammenarbeit optimiert und die Sicherheit verbessert wird.
