...
Speichersysteme und Keystone -Abonnements:: Speichersysteme sind die primären Ressourcen, die Sie in der NetApp Console verwalten. Die NetApp Console unterstützt die Verwaltung von sowohl lokalen als auch Cloud-Speichersystemen. Bevor jemand auf ein Projekt zugreifen kann, muss diesem ein Speichersystem hinzugefügt werden.
+
--
