...
NOTE: Sie benötigen die Rollen _Super Admin_, _Organisationsadministrator_ oder _Ordner- bzw. Projektadministrator_, um IAM in der NetApp Console zu verwalten.
...
--
Ordner:: Gruppieren Sie zusammengehörige Projekte in _Ordnern_, um sie nach Standort, Site oder Geschäftsbereich zu organisieren. Sie können Ressourcen nicht direkt Ordnern zuordnen, aber wenn Sie einem Benutzer auf Ordnerebene eine Rolle zuweisen, erhält er Zugriff auf alle Projekte in diesem Ordner.



NOTE: Benutzer mit der Rolle „Org admin“ können Ressourcen zu einem Ordner hinzufügen, um die Aufgabe, die Ressource Projekten zuzuordnen, an einen Ordner- oder Projektadministrator des jeweiligen Ordners zu delegieren. link:task-iam-manage-folders-projects.html#associate-resource-folder["Informationen zum Verknüpfen einer Ressource mit einem Ordner"].
...
Backup and Recovery-Workloads (Oracle und Microsoft SQL Server):: Einige Backup- und Recovery-Workloads werden ebenfalls als Ressourcen betrachtet. Weisen Sie einen Backup- und Recovery-Workload einem Projekt zu, um Benutzern Zugriff zu gewähren.
