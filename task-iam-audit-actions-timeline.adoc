...
summary: Überwachen oder prüfen Sie die Identitäts- und Zugriffsverwaltungsaktionen der NetApp Console auf der Seite „Audit“. 
---
= IAM-Aktivitäten in der NetApp Console überwachen oder prüfen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
