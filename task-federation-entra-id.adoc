...
Sie können eine Verbundverbindung mit Microsoft Entra ID einrichten, um Single Sign-On (SSO) für die Console zu aktivieren. Der Prozess beinhaltet die Konfiguration Ihrer Microsoft Entra ID, damit sie die Console als Dienstanbieter vertraut, und anschließend das Erstellen der Verbindung in der Console.
...
+
*** Verwenden Sie für die *Weiterleitungs-URL*  `https://services.cloud.netapp.com`.
...
. Stellen Sie die Verbindung mit Microsoft Entra ID her.
+
