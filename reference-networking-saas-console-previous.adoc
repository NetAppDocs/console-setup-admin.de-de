...
summary: Wenn Sie sich anmelden und die webbasierte Konsole verwenden, kontaktiert diese mehrere Endpunkte, um die von Ihnen initiierten Aktionen abzuschließen.  Computer, die auf die NetApp Console zugreifen, müssen über Verbindungen zu diesen Endpunkten verfügen. 
---
