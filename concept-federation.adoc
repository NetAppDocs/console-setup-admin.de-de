...
---
= Informationen zur Identitätsföderation in der NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Die Föderation ist nicht verfügbar, wenn sich die NetApp Console im privaten Modus befindet. link:concept-modes.html["Erfahren Sie mehr über NetApp Console-Modi"^].
...
.Protokolle
* link:task-federation-adfs.html["Active Directory-Verbunddienste (AD FS)"]
* link:task-federation-saml.html["Security Assertion Markup Language (SAML)-Identitätsanbieter"]
...
[role="quick-margin-para"]
Konfigurieren Sie Ihren Identitätsanbieter so, dass er NetApp vertraut, indem Sie eine neue Anwendung erstellen und Details wie die ACS-URL, die Entity-ID oder andere Anmeldeinformationen angeben. Die Informationen zum Dienstanbieter variieren je nach Identitätsanbieter. Konsultieren Sie daher die Dokumentation Ihres spezifischen Identitätsanbieters für Details. Sie müssen mit Ihrem IdP-Administrator zusammenarbeiten, um diesen Schritt abzuschließen.
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png["Vier"]Testen Sie Ihre Föderation in der Konsole
[role="quick-margin-para"]
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Fünf"]Aktivieren Sie Ihre Verbindung in der Konsole
[role="quick-margin-para"]
