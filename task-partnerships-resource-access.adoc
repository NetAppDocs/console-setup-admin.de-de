...
---
= Ressourcenzugriff für Partnerbenutzer in der NetApp Console bereitstellen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Sie können Partnerbenutzern die folgenden Rollen zuweisen:
...
* link:reference-iam-keystone-roles.html["Keystone -Administrator"]
...
. Wählen Sie das Aktionsmenü image:icon-action.png["ein Symbol mit drei vertikalen Punkten"] neben der bestehenden Partnerschaft, die Sie anzeigen möchten, und wählen Sie *Details anzeigen*.
+
