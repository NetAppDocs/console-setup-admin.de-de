...
* link:reference-iam-predefined-roles.html["Datenklassifizierungs-Viewer"]
* link:reference-iam-disaster-rec-roles.html["Disaster Recovery-Administrator"]
* link:reference-iam-disaster-rec-roles.html["Disaster Recovery-Failover-Administrator"]
* link:reference-iam-disaster-rec-roles.html["Disaster Recovery-Anwendungsadministrator"]
...
* link:reference-iam-ransomware-roles.html["Ransomware-Resilienz-Administrator"]
* link:reference-iam-ransomware-roles.html["Ransomware Resilience-Viewer"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Ransomware Resilience-Benutzerverhaltensadministrator"]
* link:reference-iam-ransomware-roles.html#user-behavior-roles["Ransomware Resilience-Benutzerverhaltensanzeige"]
