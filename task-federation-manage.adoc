...
NOTE: Ereignisse der Föderationsverwaltung wie das Aktivieren, Deaktivieren und Aktualisieren von Föderationen werden in der Zeitleiste angezeigt.link:task-monitor-cm-operations.html["Erfahren Sie mehr über die Überwachung von Vorgängen in der NetApp Console."]
