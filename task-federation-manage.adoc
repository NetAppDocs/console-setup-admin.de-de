...
summary: Nachdem Sie eine Verbundverbindung hinzugefügt haben, können Sie sie in der NetApp Console verwalten.  Sie können den Status der Verbindung anzeigen und sie nach Bedarf aktivieren oder deaktivieren. 
---
...
[role="lead"]
Sie können Ihre Föderation in der NetApp Console verwalten. Sie können sie deaktivieren, abgelaufene Anmeldeinformationen aktualisieren sowie sie löschen, wenn Sie sie nicht mehr benötigen.
...
[NOTE]
====
* Wenn Sie die Föderation mit NetApp Cloud Central konfiguriert haben, importieren Sie sie über die Seite *Föderation*, um sie in der Konsole zu verwalten.link:task-federation-import.html["Erfahren Sie, wie Sie Ihre Föderation importieren"]
* Auf der Seite „Überwachung“ können Sie Ereignisse der Föderationsverwaltung wie das Aktivieren, Deaktivieren und Aktualisieren von Föderationen einsehen. link:task-monitor-cm-operations.html["Erfahren Sie mehr über die Überwachung von Vorgängen in der NetApp Console."]
...
. Wählen Sie *Verwaltung > Identität und Zugriff*.
. Wählen Sie die Registerkarte *Föderation* aus.
. Wählen Sie das Aktionsmenü image:button_3_vert_dots.png["ein Symbol mit drei vertikalen Punkten"] neben der Föderation, die Sie testen möchten, und wählen Sie *Verbindung testen*.
. Wählen Sie *Test*.  Das System fordert Sie auf, sich mit Ihren Unternehmensanmeldeinformationen anzumelden.  Wenn die Verbindung erfolgreich ist, werden Sie zur NetApp Console weitergeleitet.  Wenn die Verbindung fehlschlägt, wird eine Fehlermeldung angezeigt, die auf das Problem mit der Föderation hinweist.
...
. Wählen Sie *Verwaltung > Identität und Zugriff*.
. Wählen Sie die Registerkarte *Föderation* aus.
. Wählen Sie das Aktionsmenü image:button_3_vert_dots.png["ein Symbol mit drei vertikalen Punkten"] neben der Föderation, die Sie deaktivieren möchten, und wählen Sie *Deaktivieren* aus.
...
. Wählen Sie das Aktionsmenü image:button_3_vert_dots.png["ein Symbol mit drei vertikalen Punkten"] neben dem Verbund, den Sie löschen möchten, und wählen Sie *Löschen* aus.
